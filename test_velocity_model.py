...
class TestVelocityModel(unittest.TestCase):
    ...
    def setUp(self):
        scatterer_positions = [Vector3D(500, 500, 500)]
        self.vel_bg = 4800
        self.vel_frac = 4320
    ...
    def test_close_but_outside_scatterer_radius(self):
        close_but_not_in = Vector3D(500, 500, 500.50000001)
